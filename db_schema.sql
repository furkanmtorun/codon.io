...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 14 Ağu 2019, 01:15:15
...
INSERT INTO `skills` (`id`, `user_id`, `skill_id`) VALUES
(1, 12, 194),
(2, 12, 26);
...
INSERT INTO `users` (`id`, `username`, `email`, `name`, `gender`, `avatar_link`, `password`, `about`, `registered_at`, `role_id`, `room_id`) VALUES
(10, 'joe', 'joe@gmail.com', '', '', 'https://cdn3.iconfinder.com/data/icons/luchesa-vol-9/128/Html-512.png', '$5$rounds=535000$SAGcHde1xxESJytn$dHlBw6dkyznexLKDffWxhWb8tll13hqgib.HWh0MsC1', '', '2019-08-12 21:30:29', 2, '0'),
(11, 'bill', 'bilalkabas@icloud.com', '', '', 'https://cdn3.iconfinder.com/data/icons/luchesa-vol-9/128/Html-512.png', '$5$rounds=535000$yco71sWrJvv0D5zs$WavV0KWw.Omh8HwR.9Gf4PSXCNUVwgfa/PahJsHrB/2', '', '2019-08-12 21:30:29', 2, '0'),
(12, 'furkan', 'furkanmtorun@gmail.com', 'Furkan Torun', 'Male', 'https://avatars0.githubusercontent.com/u/49681382?s=460&v=4', '$5$rounds=535000$rfQEXGfJyiD9R/oY$xqv/AYP36SU9M.CumKL52FvobSs4Uqn2Fpq/Me55320', 'let\'s dive into dreams!', '2019-08-13 20:52:12', 2, '5cd086d7-1041-4c4f-afe0-d55b83ce12f9-furkanmtorun@gmail.com'),
(13, 'ali', 'ali@gmail.com', '', '', 'https://cdn3.iconfinder.com/data/icons/luchesa-vol-9/128/Html-512.png', '$5$rounds=535000$rSQGwPaEO1ji8Sh6$.eyFmb2fy20LAiWIVP/iZvvMcQMNde3nIRg7w3DtPx6', '', '2019-08-13 20:51:01', 2, '0');
...
--
ALTER TABLE `skills`
  ADD CONSTRAINT `skill_id_rest` FOREIGN KEY (`skill_id`) REFERENCES `skill_list` (`id`),
  ADD CONSTRAINT `user_id_rest` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
